...
CREATE OR REPLACE TRIGGER TGR_EMAIL
 ...
 /
  ...
  BEGIN
    UPDATE RECIPE SET PROFILE_IMG=:new.PROFILE_IMG WHERE PROFILE_IMG=:old.PROFILE_IMG AND M_EMAIL=:old.EMAIL;
    UPDATE RECIPE_REPLY SET PROFILE_IMG=:new.PROFILE_IMG WHERE PROFILE_IMG=:old.PROFILE_IMG AND M_EMAIL=:old.EMAIL;
    UPDATE RECIPE_NESTED_REPLY SET PROFILE_IMG=:new.PROFILE_IMG WHERE PROFILE_IMG=:old.PROFILE_IMG AND M_EMAIL=:old.EMAIL;
    UPDATE BOARD SET PROFILE_IMG=:new.PROFILE_IMG WHERE PROFILE_IMG=:old.PROFILE_IMG AND M_EMAIL=:old.EMAIL;
    UPDATE BOARD_REPLY SET PROFILE_IMG=:new.PROFILE_IMG WHERE PROFILE_IMG=:old.PROFILE_IMG AND M_EMAIL=:old.EMAIL;
    UPDATE BOARD_NESTED_REPLY SET PROFILE_IMG=:new.PROFILE_IMG WHERE PROFILE_IMG=:old.PROFILE_IMG AND M_EMAIL=:old.EMAIL;
  END;
 /
