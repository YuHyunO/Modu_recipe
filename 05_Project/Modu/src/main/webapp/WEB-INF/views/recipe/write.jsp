				...
				<div class="col-md-10 main-box px-0">
					...
					<div class="category p-4 form-bg">
						<div class="form-content row align-items-center">
							...
							</select> <select class="form-select me-2" name="ingredient" id="ingredient"
								text="재료별">
								...
								<div class="row d-flex justify-content-center">
									...
									<div class="main-items px-4">
										<div class="row d-flex align-items-center mb-2 item"
											id="main-1">
											<input type="text" name="ingredient-main" class="ingredient-1 form-control input1"
												placeholder="예) 닭"> <input type="text" name="quantity-main"
							...
							<div id="seasoning-ingredient" class="col-md-6">
								<div class="row d-flex justify-content-center">
									...
									<div class="sub-items px-4">
										<div class="row d-flex align-items-center mb-2 item"
											id="sub-1">
											<input type="text" name="ingredient-sub" class="ingredient-1 form-control input1"
												placeholder="예) 설탕"> <input type="text" name="quantity-sub"
												class="quantity-1 form-control input2 mx-2"
												placeholder="예) 3T">
					...
					<div class="cooking-step p-4 form-bg" id="cooking-step">
						...
						<div class="row" id="steps">
							<div id="step-1" class="pb-3 step">
								<div class="form-label fw-bold step-text mb-0 px-1" name="setp">STEP 1</div>
