		...
		<div id="main" class="d-flex justify-content-center my-3">
			<div
				...
				<div class="col-md-10 main-box px-0">
					...
					<div class="category p-4 form-bg">
						<div class="form-content row align-items-center">
							<label class="form-label mb-1 pe-3 form-title">카테고리</label> <select
								...
								<c:if test="${(value == rs.recipe.sort) != (value == disabled)}" >
							...
							<div id="main-ingredient" class="col-md-6">
								<div class="row d-flex justify-content-center">
									...
									<div class="main-items px-4">
										...
										<c:set var="Type" value="${rs.ingredient[0].ingredientType}" />
											<c:if test="${Type eq rs.ingredient[i].ingredientType}"/>
									</c:forEach>
											<div class="row d-flex align-items-center mb-2 item"
												id="main-1">
												<input type="text" name="ingredient-main"
													class="ingredient-1 form-control input1" 
													placeholder="예) 닭" value="${rs.ingredient[0].ingredient}">
												<input type="text" name="quantity-main"
													class="quantity-1 form-control input2 mx-2"
													placeholder="예) 1마리" value="${rs.ingredient[0].quantity}">
											...
											<div class="row d-flex align-items-center mb-2 item"
												...
												<input type="text" class="ingredient-2 form-control input1"
													placeholder="예) 감자" value="${rs.ingredient[1].ingredient}"> 
													<input type="text" class="quantity-2 form-control input2 mx-2"
													placeholder="예) 1개" value="${rs.ingredient[1].quantity}">
											...
											<div class="row d-flex align-items-center mb-2 item"
												...
												<input type="text" class="ingredient-3 form-control input1"
													placeholder="예) 당근" value="${rs.ingredient[2].ingredient}"> 
													<input type="text" class="quantity-3 form-control input2 mx-2"
													placeholder="예) 1개" value="${rs.ingredient[2].quantity}">
					...
					<!-- end ingredient 재료 -->
					<div class="cooking-step p-4 form-bg" id="cooking-step">${rs.direction}
